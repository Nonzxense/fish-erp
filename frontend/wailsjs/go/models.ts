...
export namespace domain {
	...
	export class PageResult_fish_internal_domain_Container_ {
	    data: Container[];
	    total: number;
	
	    static createFrom(source: any = {}) {
	        return new PageResult_fish_internal_domain_Container_(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.data = this.convertValues(source["data"], Container);
	...
	export class PageResult_fish_internal_domain_Transaction_ {
	    data: Transaction[];
	    total: number;
	
	    static createFrom(source: any = {}) {
	        return new PageResult_fish_internal_domain_Transaction_(source);
	    }
